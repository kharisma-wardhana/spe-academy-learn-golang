...
import (
	...
	generalEntity "github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/entity"
	...
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/repository/mysql"
	...
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/usecase"
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/usecase/todo_list/entity"
...
func NewCategoryUsecase(categoryRepo mysql.ITodoListCategoryRepository, logUsecase usecase.LogUsecase) *CategoryUsecase {
	return &CategoryUsecase{categoryRepo, logUsecase}
}
...
func (c *CategoryUsecase) GetAllCategories(ctx context.Context) ([]*entity.CategoryResponse, error) {
	...
	if err != nil {
		...
		c.logUsecase.Error("CategoryUsecase.GetAllCategories", funcName, err, captureFieldError)
		return nil, err
	}
	...
	c.logUsecase.Info("Successfully retrieved all categories", funcName, captureFieldError, "CategoryUsecase")
	return response, nil
}
...
func (c *CategoryUsecase) GetCategoryByID(ctx context.Context, categoryID int64) (*entity.CategoryResponse, error) {
	...
	if err != nil {
		...
		c.logUsecase.Error("CategoryUsecase.GetCategoryByID", funcName, err, captureFieldError)
	...
	c.logUsecase.Info("Successfully retrieved category by ID", funcName, captureFieldError, "CategoryUsecase")
...
func (c *CategoryUsecase) CreateCategory(ctx context.Context, categoryReq entity.CategoryReq) (*entity.CategoryResponse, error) {
	...
	if err := c.categoryRepo.Create(ctx, nil, category, false); err != nil {
		...
		c.logUsecase.Error("CategoryUsecase.CreateCategory", funcName, err, captureFieldError)
...
func (c *CategoryUsecase) UpdateCategoryByID(ctx context.Context, categoryReq entity.CategoryReq) error {
	...
	if err := mysql.DBTransaction(c.categoryRepo, func(trx mysql.TrxObj) error {
		...
		if lockedData == nil {
			...
			c.logUsecase.Error("CategoryUsecase.UpdateCategoryByID", funcName, fmt.Errorf("category not found"), captureFieldError)
		...
		if err := c.categoryRepo.Update(ctx, trx, lockedData, &mentity.TodoListCategory{
			...
			c.logUsecase.Error("CategoryUsecase.UpdateCategoryByID", funcName, err, captureFieldError)
			return err
		}
...
func (c *CategoryUsecase) DeleteCategoryByID(ctx context.Context, categoryID int64) error {
	...
	if err != nil {
		...
		c.logUsecase.Error("CategoryUsecase.DeleteCategoryByID", funcName, err, captureFieldError)
		return err
	}
