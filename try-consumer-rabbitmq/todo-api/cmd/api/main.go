...
import (
	...
	_ "github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/docs"
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/entity"
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/http/auth"
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/http/handler"
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/parser"
	"github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/presenter/json"
	...
	todo_list_usecase "github.com/kharisma-wardhana/spe-academy-learn-golang/try-consumer-rabbitmq/todo-api/internal/usecase/todo_list"
	"go.uber.org/zap"
...
func main() {
	...
	logUsecase := usecase.NewLogUsecase(queue, logger) // LogUsecase is a sample usecase for sending log to queue (Mongodb, ElasticSearch, etc.)
	...
	categoryUsecase := todo_list_usecase.NewCategoryUsecase(todoListCategoryRepo, logUsecase)
	...
	handler.NewTodoListCategoryHandler(parser, presenterJson, categoryUsecase).Register(api)
